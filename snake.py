...
class Snake:
    ...
    # 蛇转向  new_toward 可能的值 "UP"，"DOWN"，"LEFT"，"RIGHT"
    def set_toward(self, new_toward):
        ...
        # 防止180度转头
        if (target_toward[0] + self.__toward[0] == 0) and (target_toward[1] + self.__toward[1] == 0):  # 不能转头
            return
